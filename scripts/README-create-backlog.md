# Creating GitHub Milestones and Epic Issues from `BACKLOG.md`

This script reads `BACKLOG.md` and creates GitHub milestones and epic issues using the GitHub REST API.
...
- Uses the bullet points under each epic as the issue body.
